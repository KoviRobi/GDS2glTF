...
def main():
    parser = ArgumentParser(description="Convert a GDS file to glTF")
    parser.add_argument("file", metavar="path/to/file.gds", help="Path to GDS file")
    parser.add_argument("output", nargs="?", help="Output file (default: path/to/file.gds.gltf")
    args = parser.parse_args()
    if args.output is None:
        args.output = args.file + ".gltf"
    ...
    print('Reading GDSII file {}...'.format(args.file))
    gdsii = gdspy.GdsLibrary()
    gdsii.read_gds(args.file, units='import')
